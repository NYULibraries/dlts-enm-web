...
<body>
  ...
  <main class="enm-browsetopicspage">
    ...
    <nav class="navbar has-shadow">
      <div class="container">
        <div class="navbar-tabs">
          <a class="navbar-item is-tab " href="browseTopics.php">
            ENM Picks
          </a>
          <a class="navbar-item is-tab is-active" href="browseTopics2.php">
            Most Occurrences
          </a>
    ...
    <div class="container enm-topiclist">
        ...
        <?php require('includes/browseTopics/mostOccurrences.html'); ?>
    </div>
  </main>
</body>
