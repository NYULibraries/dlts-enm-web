...
<head>
  ...
  <title>ENM Topic: Aaron ben Samuel of Baghdad, Rabbi</title>
            ...
            <div class="column">
              <header>
                ...
                <div class="title enm-topictitle">
                  Aaron ben Samuel of Baghdad, Rabbi
                </div>
              </header>
            </div>
          </div>
      ...
      <div class="container">
        <div class="enm-topic-items columns">
          <div id="topicmapholder" class="enm-topicmap column is-two-thirds">
            ...
            <svg viewBox="0 0 900 520" preserveAspectRatio="xMinYMin meet" style="height:100%; width:100%">
            </svg>
          </div>
          <div class="enm-books-with-topic column">
            <h2 class="enm-title">This topic referenced in:</h2>
            <?php require('../includes/book_gershom.html'); ?>
          </div>
        </div>
      </div>
    </section>
